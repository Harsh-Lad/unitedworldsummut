            ...
            <div className="lg:col-span-7">
              ...
              >
                <p>
                  ...
                  business forum connecting entrepreneurs across the Gulf region.
                  What started as a modest gathering of 50 delegates has grown
                  into the preeminent platform for cross-border collaboration.
                </p>
                <p>
        ...
        <Container>
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              <div className="absolute -bottom-6 -right-6 bg-navy-900 text-white px-8 py-6">
            ...
            >
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed mb-8">
                ...
                <p>
                  ...
                  governments on market entry strategies across Asia, Africa, and
                  the Middle East. His work has earned recognition from multiple
                  heads of state and international business organizations.
                </p>
              </div>
              <div className="space-y-3 border-l-2 border-gold-500 pl-6">
                <p className="text-navy-900 font-medium">Strategic Advisory Services</p>
                <p className="text-navy-900 font-medium">Government Relations</p>
                <p className="text-navy-900 font-medium">International Trade Facilitation</p>
                <p className="text-navy-900 font-medium">Cross-Border Investment</p>
              </div>
            </motion.div>
          </div>
        </Container>
          ...
          <div className="grid md:grid-cols-2 gap-16">
            ...
            >
              ...
              <p className="text-gray-400 leading-relaxed">
                To create a dynamic platform that brings together global leaders,
                entrepreneurs, and innovators to foster sustainable economic growth,
                drive digital transformation, and promote inclusive development
                across nations.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400 leading-relaxed">
                To become the world&apos;s most influential business summit, recognized
                for catalyzing meaningful partnerships, driving innovation, and
                shaping the future of global commerce in alignment with the UN
