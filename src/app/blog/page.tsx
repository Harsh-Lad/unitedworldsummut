              ...
              {featured && (
                ...
                >
                  <Link href={`/blog/${featured.slug}`} className="group block">
                    ...
                    <h2 className="font-(family-name:--font-good-times) text-base md:text-lg font-semibold text-brown-900 group-hover:text-gold-600 transition-colors leading-tight mb-3">
                      {featured.title}
                    </h2>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <h3 className="font-(family-name:--font-good-times) text-base md:text-lg font-semibold text-brown-900 group-hover:text-gold-600 transition-colors leading-snug line-clamp-2">
                          {post.title}
                        </h3>
                      </div>
                    </Link>
